...
![image](https://github.com/Chaiyapa/03376836-OOP-2566-Lab-01/assets/144195729/6b5c05a6-5f5d-4b59-8322-318606d30f2f)


❔ ถ้าพิมพ์ตัวอักษรจำนวนหลายๆ ตัวแล้วกด Enter จะได้ผลอย่างไร ทำไมจึงเป็นเช่นนั้น
![image](https://github.com/Chaiyapa/03376836-OOP-2566-Lab-01/assets/144195729/af62cbda-24f1-4a52-8a53-335721d95738)

👉👉โปรแกรมจะอ่านตัวแรกที่ถูกพิมพ์เท่านั้น และจะข้ามตัวอักษรที่เหลือไป แล้วเก็บค่าอักษรตัวแรกที่ถูกพิมพ์ในตัวแปร ch ดังนั้นผลลัพธ์ที่ได้คือการแสดงผลเฉพาะตัวอักษรแรกที่ถูกพิมพ์เท่านั้นในข้อความ "Your key is: " ตามด้วยอักษรนั้นในตัวแปร ch ที่เก็บค่าอักษรแรกที่ถูกพิมพ์ลงไปแล้ว จึงทำให้ผลลัพธ์เป็นเช่นนี้

❔ ในบรรทัดซึ่งมีโปรแกรมเป็น ch = (char)Console.Read(); นั้น ถ้าตัด (char) ออกไป จะเกิดอะไรขึ้น ให้อธิบายประกอบ

👉👉ตัด (char) ออกจากโค้ดอาจทำให้เกิดความสับสนในการอ่านและทำความเข้าใจเนื่องจากผลลัพธ์ที่ได้จะเป็น ASCII code ของอักขระแทนที่จะเป็นอักขระบางครั้งอาจทำให้โปรแกรมทำงานไม่ถูกต้องหากไม่ระวังการใช้งานข้อมูลในรูปแบบ ASCII code ให้ถูกต้อง
...
➢ รันโปรแกรมและบันทึกผล
![image](https://github.com/Chaiyapa/03376836-OOP-2566-Lab-01/assets/144195729/c4667b8d-8492-4479-bdfb-a9e563259700)
...
![image](https://github.com/Chaiyapa/03376836-OOP-2566-Lab-01/assets/144195729/bfe078b7-fc69-469f-bfcf-0ee40306375c)
...
![image](https://github.com/Chaiyapa/03376836-OOP-2566-Lab-01/assets/144195729/473351ac-20c0-4bf8-8efc-23ca01d2a68e)
...
➢ รันโปรแกรมและบันทึกผล
![image](https://github.com/Chaiyapa/03376836-OOP-2566-Lab-01/assets/144195729/dcfe4e2b-97b8-40ab-a8ef-38f30adf2af1)
