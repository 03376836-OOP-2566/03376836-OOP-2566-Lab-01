...
![image](https://github.com/fulk2014/03376836-OOP-2566-Lab-01/assets/144195753/6c23c54b-b54f-4ddb-bf83-bf06db09d558)



❔ ถ้าพิมพ์ตัวอักษรจำนวนหลายๆ ตัวแล้วกด Enter จะได้ผลอย่างไร ทำไมจึงเป็นเช่นนั้น

        ไม่มีการเปลี่บยแปลงโค้ดรันแบบเดิม


❔ ในบรรทัดซึ่งมีโปรแกรมเป็น ch = (char)Console.Read(); นั้น ถ้าตัด (char) ออกไป จะเกิดอะไรขึ้น ให้อธิบายประกอบ

erorไม่สามารถคอมไพล์ได้เนื่องจากจะเกิดข้อผิดพลาด
...
![image](https://github.com/fulk2014/03376836-OOP-2566-Lab-01/assets/144195753/c087e187-c8a8-4e80-837b-e733c3fd33e0)
...
![image](https://github.com/fulk2014/03376836-OOP-2566-Lab-01/assets/144195753/a6e72964-ba01-492e-8d3d-d546e7ea64f9)


❔ ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น มีวิธีการป้องกันหรือแก้ไขอย่างไร

ตัวอักษรจจะไม่แสดงค่าตัวอักษรออกมาป้องกันโดยใช้คำสั่งtry{…}
...
![image](https://github.com/fulk2014/03376836-OOP-2566-Lab-01/assets/144195753/ea9a5e45-a90c-4f7a-853d-8c26ce30655d)


❔ ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น เหมือนหรือต่างจากโปรแกรมก่อนหน้านี้อย่างไร

error
systemไม่สามารถประมวลผลได้
...
![image](https://github.com/fulk2014/03376836-OOP-2566-Lab-01/assets/144195753/50a4464a-1d22-4454-be61-9ac6165dc306)
