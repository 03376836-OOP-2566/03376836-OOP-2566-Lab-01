...
![5 1](https://github.com/Siriratda/03376836-OOP-2566-Lab-01/assets/144195995/bb56f4cf-d8cc-4941-bf74-678bd3f58806)

 
❔ การกำหนดความกว้างของอาร์กิวเมนต์ด้วยเครื่องหมาย { , } ในคำสั่ง ``Console.WriteLine()`` มีรูปแบบการใช้งานอย่างไร

ตัวแรกคือตำแหน่ง ตัวที่สองคือความกว้าง
...
➢ รันโปรแกรมและบันทึกผล
![image](https://github.com/Siriratda/03376836-OOP-2566-Lab-01/assets/144195995/85b5f36d-ff01-4f0c-b0d2-c70809ea89e9)



❔  การกำหนดตัวอักษร E, F, G, N, P, X หมายถึงให้พิมพ์ออกมาเป็นอะไร

 exponential fixed-point notation general separeto แบบเป็นเปอร์เซ็นต์ hexadecimal
...
➢   รันโปรแกรมและบันทึกผล
 ...
 ![image](https://github.com/Siriratda/03376836-OOP-2566-Lab-01/assets/144195995/92437b37-7241-4f5a-ade4-c05ae1975f4f)
